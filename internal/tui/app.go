...
func (a *App) updateHelp() {
	...
	lines := []string{
		...
		"  " + keyStyle.Render("Ctrl+B") + "              Toggle sidebar visibility (fullscreen grid)",
		"",
		...
		"  • " + dimStyle.Render("Sidebar Toggle") + "    - Hide sidebar for fullscreen data view",
		...
		"  • Press Ctrl+B to hide sidebar and maximize data view",
